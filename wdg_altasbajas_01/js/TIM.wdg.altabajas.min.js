...
h<j.dataEstadistica.length;h++){if(h<18){g+='<td class="textcolor-title3" id="lg'+j.dataEstadistica[h].idTeam+'">';g+='<a href="'+j.dataEstadistica[h].webNameTeam+'.html" target="_parent" class="underline_text">';

...
});setTimeout(function(){if($("#avgTIMLocal").length){var g='<img class="linkbanderalocal" src="'+$("#localImgTIM").text()+'" width="24" height="18">';
var h='<img class="linkbanderavisit" src="'+$("#visitImgTIM").text()+'" width="24" height="18">';$("#avgTIMLocal").html(g);$("#avgTIMVisit").html(h);}},5000);
e.listener=setInterval(function(){console.log("buscando etiqueta actualizable..");var h=$("#timeUpdateMxM");if($("#avgTIMLocal").length){var i='<img class="linkbanderalocal" src="'+$("#localImgTIM").text()+'" width="24" height="18">';
var j='<img class="linkbanderavisit" src="'+$("#visitImgTIM").text()+'" width="24" height="18">';$("#avgTIMLocal").html(i);$("#avgTIMVisit").html(j);}console.log(h);

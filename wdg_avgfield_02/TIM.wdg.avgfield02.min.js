...
});d.header();},header:function(){$.ajax({url:d.urlmxmheader,jsonpCallback:"mxmheader",type:"GET",dataType:"jsonp"}).done(function(e){d.timeUpdate(e.fechaPartido,e.horaPartido);
...
var g=h.substring(3,5)+"-"+h.substring(0,2)+"-"+h.substring(8,10)+" "+e.substring(0,5)+":00";$.ajax({url:"http://mxm.televisadeportes.esmas.com/deportes/home/timetvjsonp.js",async:false,cache:false,dataType:"jsonp",jsonpCallback:"timetv",success:function(o){var q="";
...
}}}else{if(parseFloat(p)>parseFloat(n)){console.log("MAYOR");}else{console.log("Error no actualizo");}}}if(f!==0){setInterval(function(){d.update();},f);
}console.log("tiempo de actualizacion "+f);}});},};if(c.idMatch!==0&&c.idTorneo!==0){d.loadMaster();}else{console.log("falta el idMatch o idTorneo");}};
})(jQuery);
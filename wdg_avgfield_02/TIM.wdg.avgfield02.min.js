...
}).fail(function(){console.log("error al cargar el feed de summary actions");});},updateData:function(n){var f=$("#LocalamarillasTIM").text(),r=$("#rojasLocalTIM").text(),i=$("#esquinaLocalTIM").text(),l=$("#tiroslocalTIM").text(),s=$("#VisitAmarillasTIM").text(),o=$("#rojasVisitTIM").text(),j=$("#esquinavisitTIM").text(),p=$("#tirosvisitLocal").text(),h=n.acciones.local.tarjeta_amarilla,k=n.acciones.local.tarjeta_roja,g=n.acciones.local.tiros_esquina,m=n.acciones.local.tiros_gol,q=n.acciones.visitant.tarjeta_amarilla;
feedvisitroja=n.acciones.visitant.tarjeta_roja,feedvisitesquina=n.acciones.visitant.tiros_esquina,feedvisitgol=n.acciones.visitant.tiros_gol;(f!==h)?$("#LocalamarillasTIM").empty().text(h):"";
(r!==k)?$("#rojasLocalTIM").empty().text(k):"";(i!==g)?$("#esquinaLocalTIM").empty().text(g):"";(m!==m)?$("#tiroslocalTIM").empty().text(m):"";(s!==q)?$("#LocalamarillasTIM").empty().text(q):"";
(o!==feedvisitroja)?$("#LocalamarillasTIM").empty().text(feedvisitroja):"";(j!==feedvisitesquina)?$("#LocalamarillasTIM").empty().text(feedvisitesquina):"";
(p!==feedvisitgol)?$("#LocalamarillasTIM").empty().text(feedvisitgol):"";},pintar:function(f){maquetado='<div class="wdg_avgfield_02" style="display:none;">';
maquetado+='<div class="str_pleca_01 collapsable">';maquetado+='<div class="str_pleca_01_title">';maquetado+='<h3 class="background-color-pleca1">';maquetado+='<a title="Link Description" class="textcolor-title3 ui-link">'+d.title+"</a></h3></div></div>";
...
maquetado+='<div class="wdg_avgfield_02_teams">';maquetado+='<div class="wdg_avgfield_02_teama">';maquetado+='<div class="element">';maquetado+=(typeof(f.acciones.local.logoch)!=="undefined")?'<img src="'+f.acciones.local.logoch+'" alt="'+f.acciones.local.equipo+'">':"";
maquetado+="</div>              ";maquetado+="</div>";maquetado+='<div class="dotted-right"></div>';maquetado+='<div class="wdg_avgfield_02_teamb">';maquetado+=(typeof(f.acciones.visitant.logoch)!=="undefined")?'<img src="'+f.acciones.visitant.logoch+'" alt="'+f.acciones.visitant.equipo+'">':"";
...
maquetado+=(typeof(f.acciones.local.tarjeta_amarilla)!=="undefined")?'<div class="element textcolor-title2" id="LocalamarillasTIM">'+f.acciones.local.tarjeta_amarilla+"</div>":"";
...
});e.listener=setInterval(function(){console.log("buscando etiqueta actualizable..");var h=$("#timeUpdateMxM");if(h.length){console.log("Antes: "+e.tmpescuchaListener);
console.log("Ahora: "+h.text());var g=parseInt(h.text());if(g>0&&parseInt(h.text())!==parseInt(e.tmpescuchaListener)){console.log("ACTUALIZANDO CON ... "+h.text());

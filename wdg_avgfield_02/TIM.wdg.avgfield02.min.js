...
feedvisitroja=n.acciones.visitant.tarjeta_roja,feedvisitesquina=n.acciones.visitant.tiros_esquina,feedvisitgol=n.acciones.visitant.tiros_gol;(f!==h)?$("#LocalamarillasTIM").text(h):"";
(r!==k)?$("#rojasLocalTIM").text(k):"";(i!==g)?$("#esquinaLocalTIM").text(g):"";(m!==m)?$("#tiroslocalTIM").text(m):"";(s!==q)?$("#LocalamarillasTIM").text(q):"";
(o!==feedvisitroja)?$("#LocalamarillasTIM").text(feedvisitroja):"";(j!==feedvisitesquina)?$("#LocalamarillasTIM").text(feedvisitesquina):"";(p!==feedvisitgol)?$("#LocalamarillasTIM").text(feedvisitgol):"";
...
e.tmpescuchaListener=parseInt(h.text());clearInterval(a);a=setInterval(function(){e.update();},g);}}},6000);}};if(d.idMatch!==0&&d.idTorneo!==0){e.loadMaster();

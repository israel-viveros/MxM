...
});e.listener=setInterval(function(){console.log("buscando etiqueta actualizable..");var h=$("#timeUpdateMxM");console.log(h);if(h.length){console.log("Antes: "+e.tmpescuchaListener);

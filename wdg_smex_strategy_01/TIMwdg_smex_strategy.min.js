(function(){$.fn.wdgStrategyMxM=function(b){var c=$.extend({ideventomxm:0,ideventomxmtv:0,idclub:0},b);var a=this;var d={urlFinalAlienacion:"http://lab.israelviveros.com/deportes/wdg_smex_strategy_01/"+c.ideventomxm+"/"+c.ideventomxmtv+"/previo_alineacion.js",urlDropdown:"http://lab.israelviveros.com/deportes/wdg_smex_strategy_01/"+c.ideventomxm+"/"+c.idclub+"/matchesclub.js",urlmxmheader:"http://lab.israelviveros.com/deportes/wdg_smex_strategy_01/"+c.ideventomxm+"/"+c.ideventomxmtv+"/mxm_header.js",PintaCacha:function(e){var f="";
if(e==="dropdown"){f+='<div class="titulo textcolor-title4">Estrategia más utilizada</div>';f+='<div class="pleca_inferior">';f+="<div>";f+="<strong>Partidos</strong>";
...
});},loadAlineacion:function(f,g,e){f.find("span.players").fadeOut("fast");$.ajax({url:"http://lab.israelviveros.com/deportes/wdg_smex_strategy_01/"+c.ideventomxm+"/"+g+"/previo_alineacion.js",dataType:"jsonp",jsonpCallback:"datagame",cache:false,success:function(H){var G="",A="",p="";
var u=new Array();var q,s,j,l;u[0]="lineuplocal";u[1]="lineUpVisit";for(var w=0;w<u.length;w++){l=String(u[w]);for(var B=0;B<H[l].team.length;B++){var m="";
var y="";var v="",D="";s=parseInt(H[l].team[B].posx);q=parseInt(H[l].team[B].posy);if(s<=290&&q<=140){m="grid1";}else{if(s<=290&&q>140){m="grid3";}else{if(s>290&&q<=140){m="grid2";
}else{m="grid4";}}}if(typeof H[l].team[B].actions!=="undefined"){v+='<em>acciones</em><span class="actions">';for(var F=0;F<H[l].team[B].actions.length;
F++){switch(H[l].team[B].actions[F].type){case"golVisitante":D="tvsa-mxm-goal";break;case"amonestacion":D="tvsa-mxm-owngoal";break;case"saleDelJuego":D="tvsa-mxm-offside";
break;case"entraAlJuego":D="tvsa-mxm-goal";break;case"expulsion":D="tvsa-mxm-redcard";break;default:D="";break;}v+='<i class="'+D+'"></i>'+H[l].team[B].actions[F].minute+"'";
}v+="</span>";}if(v==""){y+="noactions";}if(parseInt(H[l].team[B].team)===1){j="local";}else{j="visit";}G+='<span data-guid="'+H[l].team[B].guid+'" class="player '+j+" "+m+'" style="left:'+H[l].team[B].posx+"px;top:"+q+'px;"><a href="#" title="'+H[l].team[B].name+" "+H[l].team[B].name+'"><span class="number textcolor-title2">'+H[l].team[B].number+'</span><span class="tooltip '+y+'"><img class="playerfoto" src="'+H[l].team[B].image+'" alt="'+H[l].team[B].name+'" width="51" height="38" /><span class="arrow"></span><span class="name">'+H[l].team[B].name+" "+H[l].team[B].nickName+'</span><span class="position textcolor-title2">'+H[l].team[B].position+"</span>"+v+"</span></a></span>";
...
if(e==="Alineacionfinal"){for(var E=0;E<H[l].substitutes.length;E++){if(typeof H[l].substitutes[E].actions!=="undefined"){if(typeof H[l].team[E].actions!=="undefined"){var h="";
h+='<em>acciones</em><span class="actions">';for(var F=0;F<H[l].team[E].actions.length;F++){switch(H[l].team[E].actions[F].type){case"golVisitante":D="tvsa-mxm-goal";
break;case"amonestacion":D="tvsa-mxm-owngoal";break;case"saleDelJuego":D="tvsa-mxm-offside";break;case"entraAlJuego":D="tvsa-mxm-goal";break;case"expulsion":D="tvsa-mxm-redcard";
break;default:D="";break;}h+='<i class="'+D+'"></i>'+H[l].team[E].actions[F].minute+"'";}h+="</span>";}if(h===""){y+="noactions";}if(parseInt(H[l].substitutes[E].team)===1){j="local";
}else{j="visit";}for(var C=0;C<H[l].substitutes[E].actions.length;C++){if(H[l].substitutes[E].actions[C].type==="entraAlJuego"){p+=String(H[l].substitutes[E].actions[C].playeridchange)+",";
var r=$("span[data-guid="+H[l].substitutes[E].actions[C].playeridchange+"]");var o=r.css("top");var n=r.css("left");A+='<span data-guid="'+H[l].substitutes[E].guid+'" class="player '+j+" "+m+'" style="left:'+n+";top:"+o+'"><a href="#" title="'+H[l].substitutes[E].name+" "+H[l].substitutes[E].name+'"><span class="number textcolor-title2">'+H[l].substitutes[E].number+'</span><span class="tooltip"><img class="playerfoto" src="'+H[l].substitutes[E].image+'" alt="'+H[l].substitutes[E].name+'" width="51" height="38" /><span class="arrow"></span><span class="name">'+H[l].substitutes[E].name+" "+H[l].substitutes[E].nickName+'</span><span class="position textcolor-title2">'+H[l].substitutes[E].position+"</span>"+h+"</span></a></span>";
}}}}var x=p.split(",");for(var z=0;z<x.length;z++){$("span[data-guid="+x[z]+"]").remove();}f.find("span.players").append(A).fadeIn("slow");}$(".grid3 .noactions").css("top","-90px");
...
var w="";var u="";var l="",s="";positionx=parseInt(f);positiony=parseInt(g);if(positionx<=290&&positiony<=140){w="grid1";}else{if(positionx<=290&&positiony>140){w="grid3";
}else{if(positionx>290&&positiony<=140){w="grid2";}else{w="grid4";}}}if(typeof n[k].substitutes[m].actions!=="undefined"){l+='<em>acciones</em><span class="actions">';
for(var t=0;t<n[k].substitutes[m].actions.length;t++){switch(n[k].substitutes[m].actions[t].type){case"golVisitante":s="tvsa-mxm-goal";break;case"amonestacion":s="tvsa-mxm-owngoal";
break;case"saleDelJuego":s="tvsa-mxm-offside";break;case"entraAlJuego":s="tvsa-mxm-goal";break;case"expulsion":s="tvsa-mxm-redcard";break;default:s="";
break;}l+='<i class="'+s+'"></i>'+n[k].substitutes[m].actions[t].minute+"'";}l+="</span>";}if(l==""){u+="noactions";}o=(r[p]==="lineuplocal")?"local":"visit";

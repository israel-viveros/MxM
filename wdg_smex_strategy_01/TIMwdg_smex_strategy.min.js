 ...
 */
(function(){$.fn.wdgStrategyMxM=function(b){var c=$.extend({ideventomxm:0,ideventomxmtv:0,idclub:0,title:""},b);
var a=this;var d={urlFinalAlienacion:"http://static-televisadeportes.esmas.com/sportsdata/futbol/data/"+c.ideventomxm+"/"+c.ideventomxmtv+"/match_lineup.js",urlDropdown:"http://static-televisadeportes.esmas.com/sportsdata/futbol/data/"+c.ideventomxm+"/clubes/"+c.idclub+"/matchesclub.js",urlmxmheader:"http://static-televisadeportes.esmas.com/sportsdata/futbol/data/"+c.ideventomxm+"/"+c.ideventomxmtv+"/match_header.js",PintaCacha:function(e){var f="";
...
$.ajax({url:d.urlDropdown,dataType:"jsonp",jsonpCallback:"effectivenessByTeam",cache:false}).done(function(g){e+='<ul class="wdg_smex_strategy_01_dropdownlist">';
...
});},loadAlineacion:function(f,g,e){f.find("span.players").fadeOut("fast");$.ajax({url:"http://static-televisadeportes.esmas.com/sportsdata/futbol/data/356/24911/match_lineup.js",dataType:"jsonp",jsonpCallback:"datagame",cache:false,success:function(H){var G="",z="",p=new Array();

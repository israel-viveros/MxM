...
case 11:f="Nov";break;case 12:f="Dic";break;}e+="<li>";e+='<div class="textcolor-title2 time">'+g[0]+" "+f+"</div>";e+='<div class="chronic">';e+='<div class="logoTeam"><img src="'+j[h].icon+'" alt="Image description"> </div>';
e+=(typeof(j[h].Jugador)!=="undefined")?"<h2>"+j[h].Jugador+"</h2>":"";e+=(typeof(j[h].descripcion)!=="undefined")?'<div class="chronic_description">'+j[h].descripcion+"</div>":"";
e+="</div>";e+="</li>";}a.find("ul.wdg_mxm_live_03_list").html(e);c.funcionesNAAT();}).fail(function(){console.log("error al cargar el feed "+c.feedActions);
});},funcionesNAAT:function(){jQuery(function(e){(function(j,i){function g(){j(".wdg_mxm_live_03 .not_here").hide();j(".wdg_mxm_live_03 .vid_player_01 .not_here").hide();
j(".wdg_mxm_live_03 .img_stage_01 .not_here").hide();j(".wdg_mxm_live_03 .vid_player_01 .not_here").css("display","none");j(".wdg_mxm_live_03 .img_stage_01 .not_here").css("display","none");
j(".wdg_mxm_live_03 .tvsa-videocamera").removeClass("tvsa-mxm-close");j(".wdg_mxm_live_03 .tvsa-camera").show();}j(".wdg_mxm_live_03").each(function(k,l){var o=j(this),n={UP:(i.getIsTouchDevice())?"touchend":"mouseup",DOWN:(i.getIsTouchDevice())?"touchstart":"mousedown"},m=o.find(".wdg_mxm_live_03_list");

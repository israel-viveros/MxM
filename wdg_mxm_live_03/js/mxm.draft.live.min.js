 ...
 */
(function(){$.fn.mxmLiveDraft=function(d){var b=$.extend({idTournament:0,nameTournament:""},d);
var a=this;var c={feedActions:"http://static-televisadeportes.esmas.com/sportsdata/futbol/draft/"+b.nameTournament+"/mxmDraft.js",drawMaquetado:function(){var g="";
g+='<div class="wdg_mxm_live_03"> ';g+='<div class="scroll">';g+='<div class="wdg_mxm_live_03_status">';g+='<ul class="wdg_mxm_live_03_list"></ul>';g+="</div></div>";
g+='<div class="arrow_buttons"> ';g+='<a href="#" title="Link Description" class="prev ui-link"><div class="dropdown-white"><i class="tvsa-caret-up"></i></div></a> ';
g+='<a href="#" title="Link Description" class="next ui-link"><div class="dropdown-white"><i class="tvsa-caret-down"></i></div></a>  ';g+="</div>";g+='<div class="degraded"></div>';
g+="</div>";a.html(g);try{c.loadFeed();}catch(f){console.log(f);}},loadFeed:function(){var e="";$.ajax({url:c.feedActions,type:"GET",jsonpCallback:"actionsDraft",dataType:"jsonp",cache:false}).done(function(j){console.log(j);
...
case 11:f="Nov";break;case 12:f="Dic";break;}e+="<li>";e+='<div class="textcolor-title2 time">'+g[0]+"."+f;e+=((j[h].hora)!=="undefined")?"<p>"+j[h].hora.substring(0,5)+"</p></div>":"</div>";
e+='<div class="chronic">';e+='<div class="logoTeam"><img src="'+j[h].icon+'" > </div>';e+=(typeof(j[h].Jugador)!=="undefined")?"<h2>"+j[h].Jugador+"</h2>":"";

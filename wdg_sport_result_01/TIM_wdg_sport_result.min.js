(function(){$.fn.WdgSportResult=function(b){var c=$.extend({idtorneo:0,idteam:0},b);var a=this;var d={urlFinalHeader:"http://static-televisadeportes.esmas.com/sportsdata/futbol/data/"+c.idtorneo+"/"+c.idteam+"/match_header.js",jsonpcallback:"mxmheader",IdPestanasMenu:$("#TIMnav_smnu_sports"),loadInfo:function(e){$.ajax({url:d.urlFinalHeader,type:"GET",dataType:"jsonp",jsonpCallback:d.jsonpcallback,cache:false}).done(function(f){(e==="update")?d.updateGoles(f):d.drawHeader(f);
...
}e+="</div>";e+="</div>";e+='<div class="date_venue">';e+='<div class="when">'+f.fechaPartidoLetra.replace(/-/g," ")+" "+f.horaPartido+"</div>";e+=(typeof f.estadio!=="undefined")?'<div class="where">Estadio '+f.estadio.nombre+", "+f.estadio.ciudad+", "+f.estadio.pais+"</div>":"";

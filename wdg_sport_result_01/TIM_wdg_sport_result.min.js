...
}else{if(parseFloat(s)==parseFloat(q)){console.log("Dia del Evento");var v=y.getTime(),l=x.getTime(),k=9000000,u=900000,w=v+k,A=v-u,p=v-l;console.log("Hora Servidor: "+new Date(l));
...
if(f.length){f.removeClass("hidden");}h=30000;}else{console.log(p);if(parseInt(p)<u&&parseInt(p)>0){console.log("Estamos a menos de 15 min del partido");
h=300000;}}}else{if(parseFloat(s)>parseFloat(q)){console.log("Fecha Mayor (AUN NO PASA EL PARTIDO)");}else{console.log("Error no actualizo");}}}if(h===0){h=(z!=="final"&&z!=="previo")?30000:0;
...
e.loadInfo("update");},h);}$("#timeUpdateMxM").text(h);}});},drawMenu:function(h){var g="";g+='<div class="navarrowleft">';g+='<a class="wdg_matchesresult_navleft" href="#left"> ';
g+='<span class="navlefticon"><i class="tvsa-double-caret-left inactive"></i></span></a></div>';g+='<div class="container">';g+='<div class="nav_smnu_sports_01_bar"><ul>';
g+=(typeof h.previo!=="undefined"&&h.previo!=="")?'<li class="previoMenuTim"> <a href="'+h.previo+'" target="_parent">Previo</a></li>':"";g+=(typeof h.alineacion!=="undefined"&&h.alineacion!=="")?'<li class="nav_smnu_sports_01_block alineacionMenuTim"><a href="'+h.alineacion+'" target="_parent" title="Alineaci\u00F3n">Alineaci\u00F3n</a></li>':"";

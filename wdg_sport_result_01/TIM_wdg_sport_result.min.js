...
(/camara360.html/.test(h))?$(".camara360").addClass("current"):"";if(c.tema==="mundial"){var g=[25521,25395,25487,25488];for(var f=0;f<g.length;f++){if(parseInt(c.idteam)===g[f]){$(".interaMenuTim").css("display","none");

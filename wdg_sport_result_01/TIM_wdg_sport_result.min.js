...
}}setInterval(function(){d.loadInfo("update");},f);}else{if(parseFloat(p)>parseFloat(n)){}else{}}}}});},drawMenu:function(g){var f="";f+='<div class="navarrowleft">';
f+='<a class="wdg_matchesresult_navleft" href="#left"> ';f+='<span class="navlefticon">';f+='<i class="tvsa-double-caret-left inactive"></i>';f+="</span>";
f+="</a>";f+="</div>";f+='<div class="container">';f+='<div class="nav_smnu_sports_01_bar">';f+="<ul>";f+=(typeof g.previo!=="undefined"&&g.previo!=="")?'<li class="previoMenuTim"> <a href="'+g.previo+'">Previo</a></li>':"";
f+=(typeof g.alineacion!=="undefined"&&g.alineacion!=="")?'<li class="nav_smnu_sports_01_block alineacionMenuTim"><a href="'+g.alineacion+'" title="Alineaci\u00F3n">Alineaci\u00F3n</a></li>':"";

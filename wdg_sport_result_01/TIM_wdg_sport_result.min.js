...
(f==="update"&&typeof(g.paginas)!=="undefined"&&e.IdPestanasMenu.length)?e.drawMenu(g.paginas):"";}).fail(function(g){console.log("Error al cargar: "+e.urlFinalHeader);
...
u+='<div class="wrapper"><div class="match_title">';u+='<span class="hidden" id="datosTIMHeader"><span id="linklocalTIM">'+k.equipoLocal.url+'</span> <span id="linkvisitTIM">'+k.equipoVisitante.url+'</span> <span id="timeUpdateMxM">0</span> <span id="localAbrevTIM" class="hidden">'+k.equipoLocal.abrev+'</span> <span id="visitAbrevTIM" class="hidden">'+k.equipoVisitante.abrev+'</span> <span id="localImgTIM" class="hidden">'+h+'</span> <span id="visitImgTIM" class="hidden">'+f+'</span> <span id="localGolesTIM" class="hidden">'+k.equipoLocal.goles+'</span> <span id="visitGolesTIM" class="hidden">'+k.equipoVisitante.goles+"</span>  </span>";
...
},60000);}(typeof k.paginas!=="undefined"&&e.IdPestanasMenu.length)?e.drawMenu(k.paginas):e.IdPestanasMenu.hide();if(c.tema==="mundial"&&k.tiempo==="Final"){var t=new Array(25371,25374,25376,25377,25379,25381,25368,25370);

...
r+=(typeof k.estadio!=="undefined"&&k.estadio.nombre!=="")?'<div class="where">Estadio '+k.estadio.nombre+"<br>"+k.estadio.ciudad+", "+k.estadio.pais+"</div>":"";
r+=(typeof k.datocurioso!=="undefined")?'<div class="info">'+k.datocurioso+"</div>":"";r+="</div>";r+="</div>";a.css("display","none").html(r).slideDown("slow",function(){$(this).css({display:"block"});
...
},60000);}(typeof k.paginas!=="undefined"&&e.IdPestanasMenu.length)?e.drawMenu(k.paginas):e.IdPestanasMenu.hide();var q=$("#linklocalTIM").text();var m=$("#linkvisitTIM").text();
$(document).on("click",".linkbanderalocal",function(s){s.preventDefault();(q!=="")?window.open(q,"_blank"):"";});$(document).on("click",".linkbanderavisit",function(s){s.preventDefault();
(m!=="")?window.open(m,"_blank"):"";});$(document).on("hover",".linkbanderalocal",function(){if(q!==""){$(this).css("cursor","pointer");}});$(document).on("hover",".linkbanderavisit",function(){if(m!==""){$(this).css("cursor","pointer");
}});var g=0;var j=setInterval(function(){g++;if(g>5){clearInterval(j);}$("img.linkbanderalocal").attr("src",$("#localImgTIM").text());$("img.linkbanderavisit").attr("src",$("#visitImgTIM").text());
},3000);},updateGoles:function(k){var h="",h="",i="",m="",n="",r="",u="",j="",f="",l="",g="",t="",s="",q="",p="",o=(parseInt(k.minuto)!==0)?k.minuto+"'":"";
...
}}}}});},drawMenu:function(k){var i="";i+='<div class="navarrowleft">';i+='<a class="wdg_matchesresult_navleft" href="#left"> ';i+='<span class="navlefticon"><i class="tvsa-double-caret-left inactive"></i></span></a></div>';
i+='<div class="container">';i+='<div class="nav_smnu_sports_01_bar"><ul>';i+=(typeof k.previo!=="undefined"&&k.previo!=="")?'<li class="previoMenuTim"> <a href="'+k.previo+'" target="_parent">Previo</a></li>':"";
i+=(typeof k.alineacion!=="undefined"&&k.alineacion!=="")?'<li class="nav_smnu_sports_01_block alineacionMenuTim"><a href="'+k.alineacion+'" target="_parent" title="Alineaci\u00F3n">Alineaci\u00F3n</a></li>':"";
i+=(typeof k.rating!=="undefined"&&k.rating!==""&&c.tema!=="mundial")?'<li class="hide1 ratingMenuTim"><a href="'+k.rating+'" title="Rating">Rating</a></li>':"";
i+=(typeof k.mxm!=="undefined"&&k.mxm!=="")?'<li class="nav_smnu_sports_01_block nav_smnu_sports_01_block2 mxmMenuTim"><a href="'+k.mxm+'" target="_parent" title="MxM">MxM</a></li>':"";
i+=(typeof k.pizarra!=="undefined"&&k.pizarra!==""&&c.tema!=="mundial")?'<li class="hide2 pizarraMenuTim"><a href="'+k.pizarra+'" title="Pizarra">Pizarra</a></li>':"";
i+=(typeof k.cronica!=="undefined"&&k.cronica!=="")?'<li class="nav_smnu_sports_01_block nav_smnu_sports_01_block2 cronicaMenuTim"><a href="'+k.cronica+'" target="_parent" title="Cr\u00F3nica">Cr\u00F3nica</a></li>':"";
i+=(typeof k.video!=="undefined"&&k.video!=="")?'<li class="last nav_smnu_sports_01_block videoMenuTim"><a href="'+k.video+'" title="Video" target="_parent">Video</a></li>':"";
i+=(c.idteam===25521||c.idteam===25395||c.idteam===25487||c.idteam===25488||c.idteam===25335||c.idteam===25334)?'<li class="last nav_smnu_sports_01_block camara360"><a href="camara360.html" title="camara" target="_parent">C\u00E1mara 360</a></li>':"";
...
e.IdPestanasMenu.html(i).show();var h=document.URL;(/previo.html/.test(h))?$(".previoMenuTim").addClass("current"):"";(/alineacion.html/.test(h))?$(".alineacionMenuTim").addClass("current"):"";
(/rating.html/.test(h))?$(".ratingMenuTim").addClass("current"):"";(/mxm.html/.test(h))?$(".mxmMenuTim").addClass("current"):"";(/pizarra.html/.test(h))?$(".pizarraMenuTim").addClass("current"):"";
(/cronica.html/.test(h))?$(".cronicaMenuTim").addClass("current"):"";(/video.html/.test(h))?$(".videoMenuTim").addClass("current"):"";(/interacciontd.html/.test(h))?$(".interaMenuTim").addClass("current"):"";
(/camara360.html/.test(h))?$(".camara360").addClass("current"):"";(/previo_d.html/.test(h))?$(".previoMenuTim").addClass("current"):"";(/alineacion_d.html/.test(h))?$(".alineacionMenuTim").addClass("current"):"";
(/rating_d.html/.test(h))?$(".ratingMenuTim").addClass("current"):"";(/mxm_d.html/.test(h))?$(".mxmMenuTim").addClass("current"):"";(/pizarra_d.html/.test(h))?$(".pizarraMenuTim").addClass("current"):"";
(/cronica_d.html/.test(h))?$(".cronicaMenuTim").addClass("current"):"";if(c.tema==="mundial"){var g=[25521,25395,25487,25488];for(var f=0;f<g.length;f++){if(parseInt(c.idteam)===g[f]){$(".interaMenuTim").css("display","none");
}}var j=[25335,25334];for(var l=0;l<j.length;l++){if(c.idteam===j[l]){$(".interaMenuTim, .camara360").css("display","inline");e.IdPestanasMenu.addClass("mexspecial");
}}(c.idteam===25368)?$(".interaMenuTim").remove():"";}}};if(c.idtorneo!==0&&c.idteam!==0){setTimeout(function(){e.loadInfo();},300);}else{(console.log("---->Faltan los Id's de team y/o torneo"));
}};})(jQuery);
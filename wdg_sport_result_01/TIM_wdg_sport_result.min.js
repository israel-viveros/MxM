...
(/video.html/.test(h))?$(".videoMenuTim").addClass("current"):"";(/interacciontd.html/.test(h))?$(".interaMenuTim").addClass("current"):"";if(c.tema==="mundial"){var g=[25521,25395,25487,25488];
for(var f=0;f<g.length;f++){if(parseInt(c.idteam)===g[f]){$(".interaMenuTim").css("display","none");}}}}};if(c.idtorneo!=0&&c.idteam!==0){setTimeout(function(){e.loadInfo();

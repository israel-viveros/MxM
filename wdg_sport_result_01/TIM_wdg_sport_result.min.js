...
e+='<div class="realtedimg"><img src="http://placehold.it/300x50" alt=""></div>';e+="</div>";e+='<div class="live_time textcolor-title3 background-color1">'+f.tiempo.replace(/'/g,"'")+"</div>";
...
e+="</div>";e+="</div>";a.css("display","none").html(e).slideDown("slow",function(){$(this).css({display:"block"});});if(f.tiempo.toLowerCase()!="final"){d.timeUpdate(f.fechaPartido,f.horaPartido);
}(typeof f.paginas!=="undefined"&&d.IdPestanasMenu.length)?d.drawMenu(f.paginas):d.IdPestanasMenu.hide();},updateGoles:function(j){var g="",g="",h="",l="",m="",p="",s="",i="",e="",k="",f="",r="",q="",o="",n="";
...
},drawMenu:function(g){var f="";f+='<div class="navarrowleft">';f+='<a class="wdg_matchesresult_navleft" href="#left"> ';f+='<span class="navlefticon"><i class="tvsa-double-caret-left inactive"></i></span></a></div>';
...
d.IdPestanasMenu.html(f).show();var e=document.URL;(/previo/.test(e))?$(".previoMenuTim").addClass("current"):"";(/alineacion/.test(e))?$(".alineacionMenuTim").addClass("current"):"";

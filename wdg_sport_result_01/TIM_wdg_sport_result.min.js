...
$(this).text(f).slideDown("fast");});},timeUpdate:function(i,f){console.log("Metod -> timeUpdate");var e=$("#TIMVivoHeader");var g=0;var h=i.substring(3,5)+"-"+i.substring(0,2)+"-"+i.substring(8,10)+" "+f.substring(0,5)+":00";
...
if(parseFloat(q)<parseFloat(o)){console.log("Fecha Menor");}else{if(parseFloat(q)==parseFloat(o)){console.log("Dia del Evento");g=60000;var k=parseInt(u.getHours()-v.getHours());
if(u.getHours()>=v.getHours()){console.log("ya empezo el partido");g=60000;}else{var t=v.getHours();var s=u.getHours();var x=v.getMinutes();var w=u.getMinutes();
var j=(((t-s)*60)+x)-w;if(j<=15){console.log("faltan menos de 15 min");g=60000;if(e.length){e.removeClass("hidden");}}else{console.log("faltan mas de 15 pero menos de 1hr "+j);
(j>60)?g=900000:"";if(e.length){e.removeClass("hidden");}}}if(g!==0){setInterval(function(){d.loadInfo("update");},g);}console.log("el tiempo de actualizacion es: "+g);
}else{if(parseFloat(q)>parseFloat(o)){console.log("Fecha Mayor");}else{console.log("Error no actualizo");}}}}});},drawMenu:function(g){var f="";f+='<div class="navarrowleft">';

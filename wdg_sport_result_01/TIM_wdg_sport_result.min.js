...
(j>60)?g=900000:"";if(e.length){e.removeClass("hidden");}}}}else{if(parseFloat(q)>parseFloat(o)){console.log("Fecha Mayor");a.find(".score").css("visibility","hidden");
}else{console.log("Error no actualizo");}}}$("#timeUpdateMxM").text(g);if(g!==0){setInterval(function(){d.loadInfo("update");},g);}}});},drawMenu:function(g){var f="";
f+='<div class="navarrowleft">';f+='<a class="wdg_matchesresult_navleft" href="#left"> ';f+='<span class="navlefticon"><i class="tvsa-double-caret-left inactive"></i></span></a></div>';

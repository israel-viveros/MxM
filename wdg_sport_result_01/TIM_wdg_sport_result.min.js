...
}else{if(parseFloat(r)==parseFloat(p)){console.log("Dia del Evento");var u=x.getTime(),k=w.getTime(),j=9000000,t=900000,v=u+j,y=u-t,o=y-k;console.log("Hora Servidor: "+new Date(k));
...
if(e.length){e.removeClass("hidden");}g=30000;a.find(".score").css("visibility","visible");}else{if(parseInt(o)<0){console.log("Estamos a 15 min del partido");
...
if(g!==0){setInterval(function(){d.loadInfo("update");},g);}if(!$("#timeUpdateMxM").length){$("#datosTIMHeader").append('<span id="timeUpdateMxM">'+g+"</span>");
}else{$("#timeUpdateMxM").text(g);}}});},drawMenu:function(g){var f="";f+='<div class="navarrowleft">';f+='<a class="wdg_matchesresult_navleft" href="#left"> ';

...
}).fail(function(g){console.log("Error al cargar: "+e.urlFinalHeader);console.log(g);});},drawHeader:function(i){var h='<img class="linkbanderalocal" src="'+i.equipoLocal.lineupImage+'" alt="'+i.equipoLocal.nombre+'" width="48" height="36">';
var f='<img class="linkbanderavisit" src="'+i.equipoVisitante.lineupImage+'" width="48" height="36" alt="'+i.equipoVisitante.nombre+'">';var k='<span class="linkbanderalocal">'+i.equipoLocal.nombre+"</span>";
var j='<span class="linkbanderavisit">'+i.equipoVisitante.nombre+"</span>";var g="",l=(parseInt(i.minuto)!==0)?i.minuto+"'":"";g+='<div class="wrapper"><div class="match_title">';
g+='<span class="hidden" id="datosTIMHeader"><span id="linklocalTIM">'+i.equipoLocal.url+'</span> <span id="linkvisitTIM">'+i.equipoVisitante.url+'</span> <span id="timeUpdateMxM">0</span> <span id="localAbrevTIM" class="hidden">'+i.equipoLocal.abrev+'</span> <span id="visitAbrevTIM" class="hidden">'+i.equipoVisitante.abrev+'</span> <span id="localImgTIM" class="hidden">'+i.equipoLocal.smallImage+'</span> <span id="visitImgTIM" class="hidden">'+i.equipoVisitante.smallImage+'</span> <span id="localGolesTIM" class="hidden">'+i.equipoVisitante.goles+'</span> <span id="visitGolesTIM" class="hidden">'+i.equipoVisitante.goles+"</span>  </span>";
g+='<div class="cup_name">';g+=(i.transmisionVivo!=="")?'<div class="live-container textcolor-title3 background-color2 hidden" id="TIMVivoHeader" onclick="javascript:window.open(\''+i.transmisionVivo+'\');" style="cursor:pointer"><div class="icon-video"><i class="tvsa-videocamera"></i></div><div class="see-now">VER AHORA</div><div class="online">EN VIVO</div></div>':"";
g+='<div class="titulo textcolor-title3">'+i.torneo.nombre+"</div>";g+='<div class="subtitulo textcolor-title2">'+i.jornada.nombre+"</div>";g+="</div>";
g+="</div>";g+='<div class="live_time textcolor-title3 background-color1"><span>'+i.tiempo.replace(/'/g,"'")+" "+l+"</span></div>";g+='<div class="leftside">';
g+=(c.tema==="mundial")?'<div class="padre">':"";g+='<div class="team1">';g+='<div class="escudo">'+h+"</div>";g+='<div class="equipo">'+k+"</div>";g+='<div class="score">'+i.equipoLocal.goles+"</div>";
g+=(i.equipoLocal.penales===""||parseInt(i.equipoLocal.penales)===0)?'<div class="penales" style="visibility:hidden"><span class="penal"></span> PENALES</div>':'<div class="penales"><span class="penal">'+i.equipoLocal.penales+"</span> PENALES</div>";
g+="</div>";g+='<div class="dotted_separator"></div>';g+='<div class="team2">';g+=(i.equipoVisitante.penales===""||parseInt(i.equipoVisitante.penales)===0)?'<div class="penales" style="visibility:hidden"><span class="penal"></span> PENALES</div>':'<div class="penales"><span class="penal">'+i.equipoVisitante.penales+"</span> PENALES</div>";
g+='<div class="score">'+i.equipoVisitante.goles+"</div>";g+='<div class="equipo">'+j+"</div>";g+='<div class="escudo">'+f+"</div>";g+="</div>";g+='<div class="team2_m">';
g+=(i.equipoVisitante.lineupImage!=="")?'<div class="escudo">'+f+"</div>":"";g+='<div class="equipo">'+j+"</div>";g+='<div class="score">'+i.equipoVisitante.goles+"</div>";
g+=(i.equipoVisitante.penales===""||parseInt(i.equipoVisitante.penales)===0)?'<div class="penales" style="visibility:hidden"><span class="penal"></span> PENALES</div>':'<div class="penales"><span class="penal">'+i.equipoVisitante.penales+"</span> PENALES</div>";
g+="</div>";g+=(c.tema!=="mundial")?'<div class="solid_separator"></div>':"";g+='<div class="match_info">';g+=(typeof i.partidoIda!=="undefined")?'<div class="ida">Partido ida: <span class="blanco">'+i.partidoIda.local+" "+i.partidoIda.golesLocal+" - "+i.partidoIda.golesVisitante+" "+i.partidoIda.visitante+"</span></div>":"";
if(parseInt(i.equipoLocal.golesGlobal)!==0||parseInt(i.equipoVisitante.golesGlobal)!==0){g+='<div class="scoreglobal">Global: <span class="blanco">'+i.equipoLocal.nombre+' <span id="globalLoc">'+i.equipoLocal.golesGlobal+'</span> - <span id="globalVi">'+i.equipoVisitante.golesGlobal+"</span> "+i.equipoVisitante.nombre+"</span></div>";
}g+="</div>";g+="</div>";g+=(c.tema==="mundial")?'<div class="solid_separator"></div></div>':"";g+='<div class="date_venue">';g+='<div class="when">'+i.fechaPartidoLetra.replace(/-/g," ")+" <span>"+i.horaPartido+"</span></div>";
g+=(typeof i.estadio!=="undefined")?'<div class="where">Estadio '+i.estadio.nombre+"<br>"+i.estadio.ciudad+", "+i.estadio.pais+"</div>":"";g+=(typeof i.datocurioso!=="undefined")?'<div class="info">'+i.datocurioso+"</div>":"";
g+="</div>";g+="</div>";a.css("display","none").html(g).slideDown("slow",function(){$(this).css({display:"block"});});if(i.tiempo.toLowerCase()!=="final"){setTimeout(function(){e.timeUpdate(i.fechaPartido,i.horaPartido);
},300);setInterval(function(){e.timeUpdate(i.fechaPartido,i.horaPartido);},60000);}(typeof i.paginas!=="undefined"&&e.IdPestanasMenu.length)?e.drawMenu(i.paginas):e.IdPestanasMenu.hide();
$(document).on("click",".linkbanderalocal",function(n){n.preventDefault();var m=$("#linklocalTIM").text();console.log("click local");(m!=="")?window.open(m,"_blank"):"";
});$(document).on("click",".linkbanderavisit",function(){event.preventDefault();var m=$("#linkvisitTIM").text();console.log("click ");(m!=="")?window.open(m,"_blank"):"";
});},updateGoles:function(k){var h="",h="",i="",m="",n="",r="",u="",j="",f="",l="",g="",t="",s="",q="",p="",o=(parseInt(k.minuto)!==0)?k.minuto+"'":"";

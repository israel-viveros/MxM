...
if(f.length){f.removeClass("hidden");}h=20000;}else{console.log(p);if(parseInt(p)<u&&parseInt(p)>0){console.log("Estamos a menos de 15 min del partido");
h=300000;}}}else{if(parseFloat(s)>parseFloat(q)){console.log("Fecha Mayor (AUN NO PASA EL PARTIDO)");}else{console.log("Error no actualizo");}}}if(h===0){h=(z!=="final"&&z!=="previo")?20000:0;

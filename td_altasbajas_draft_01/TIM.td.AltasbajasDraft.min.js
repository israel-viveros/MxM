 ...
 */
(function(){$.fn.MxMAltasBajasDraft=function(c){var d=$.extend({idTorneo:0,nameTournament:""},c);
console.log("Altas Bajas Draft");var a={urlData:"http://static-televisadeportes.esmas.com/sportsdata/futbol/draft/"+d.nameTournament+"/teamdraft.js",tagWdgPlayerdraft:$("#containerwdg_playerdraft_01"),viewHtml:function(o){var f="";
...
p<o.draftTeams.length;p++){for(var g=0;g<o.draftTeams[p]["operation"].length;g++){var l="";var m="";var h="";var r="";var q="";var j="";var e="";var k="";
e=o.draftTeams[p]["operation"][g]["id"];l=o.draftTeams[p]["operation"][g]["name"];m=o.draftTeams[p]["operation"][g]["acquire"];h=o.draftTeams[p]["operation"][g]["transfer"];
...
k=k[4];maquetado+="<tr class='vote_block'>";maquetado+="<td class='dotted-right'>";maquetado+="<h3 data-urlDraft='"+u+"' data-url='http://polls.esmas.com/jugadores/torneo/"+d.idTorneo+"/partido/"+e+"/jugador/"+k+"'>"+l+"</h3>";
...
}},getDataDraft:function(){console.log(a.urlData);$.ajax({url:a.urlData,type:"GET",dataType:"jsonp",jsonpCallback:"teamDraft",cache:false,success:function(e){a.viewHtml(e);

...
r+='<div class="img_stage_01_image"> <img src="'+p.actionsMXM[k].datarelated[j].url+'" alt="Image description"> </div>';if(typeof p.actionsMXM[k].datarelated[j].imagenTitulo!=="undefined"&&typeof p.actionsMXM[k].datarelated[j].imagenDesc!=="undefined"){r+=(p.actionsMXM[k].datarelated[j].imagenDesc!=="")?'<a class="img_stage_01_whtbkg" href="#"><p class="img_stage_01_black">'+p.actionsMXM[k].datarelated[j].imagenTitulo+"</p>":"";
r+=(p.actionsMXM[k].datarelated[j].imagenTitulo!=="")?'<p class="img_stage_01_gray">'+p.actionsMXM[k].datarelated[j].imagenDesc+"</p></a>":"";r+="</div>";
}}if(p.actionsMXM[k].datarelated[j].type.toLowerCase()==="video"){o+='<div class="vid_player_01 not_here" style="display: none;">';o+='<div class="vid_player_01_image">';
o+='<iframe width="100%" height="100%" src="" data-id="'+p.actionsMXM[k].datarelated[j].id+'" ></iframe>';o+='<div class="theaterContainer">';o+='<div class="theaterSideSpacer"></div>';
o+='<div class="theaterContainerVideo">';o+='<div class="videoLink"></div>';o+='<div class="contenedor"></div>';o+="</div>";o+='<div class="theaterSideSpacer"></div>';
o+="</div>";o+='<div class="companionBanner"></div>';o+="</div>";o+="</div>";}}}f+=(o!=="")?'<div class="icon-interactive textcolor-title4"> <i class="tvsa-videocamera"></i><i class="tvsa-error not-displayed"></i> </div>':"";
...
});}else{$(this).removeClass("active textcolor-title1 tvsa-error");i.slideUp("slow",function(){g=$(this).find("iframe");g.attr({src:""});});}});},updateMxm:function(){console.log("funcion updateMxm");
var f="",g="";$.ajax({url:d.urlFinal,type:"GET",dataType:"jsonp",jsonpCallback:d.callback,cache:false}).done(function(n){var h=Math.floor((1+Math.random())*65536).toString(16);
var r=c.find("#pintaAcciones").children("li").size();var u=n.actionsMXM.length;if(u>r){var p=u-r;for(var o=0;o<p;o++){var j="",t="";switch(n.actionsMXM[o].type.toLowerCase()){case"amonestacion":clase="tvsa-mxm-yellowcard";
...
t+='<div class="img_stage_01_image"> <img src="'+n.actionsMXM[o].datarelated[m].url+'" alt="Image description"> </div>';if(typeof n.actionsMXM[o].datarelated[m].imagenTitulo!=="undefined"&&typeof n.actionsMXM[o].datarelated[m].imagenDesc!=="undefined"){t+=(n.actionsMXM[o].datarelated[m].imagenDesc!=="")?'<a class="img_stage_01_whtbkg" href="#"><p class="img_stage_01_black">'+n.actionsMXM[o].datarelated[m].imagenTitulo+"</p>":"";
t+=(n.actionsMXM[o].datarelated[m].imagenTitulo!=="")?'<p class="img_stage_01_gray">'+n.actionsMXM[o].datarelated[m].imagenDesc+"</p></a>":"";t+="</div>";
}}if(n.actionsMXM[o].datarelated[m].type.toLowerCase()==="video"){j+='<div class="vid_player_01 not_here" style="display: none;">';j+='<div class="vid_player_01_image">';
j+='<iframe width="100%" height="100%" src="" data-id="'+n.actionsMXM[o].datarelated[m].id+'" ></iframe>';j+='<div class="theaterContainer">';j+='<div class="theaterSideSpacer"></div>';
j+='<div class="theaterContainerVideo">';j+='<div class="videoLink"></div>';j+='<div class="contenedor"></div>';j+="</div>";j+='<div class="theaterSideSpacer"></div>';
j+="</div>";j+='<div class="companionBanner"></div>';j+="</div>";j+="</div>";}}}f+=(j!=="")?'<div class="icon-interactive textcolor-title4"> <i class="tvsa-videocamera"></i><i class="tvsa-error not-displayed"></i> </div>':"";

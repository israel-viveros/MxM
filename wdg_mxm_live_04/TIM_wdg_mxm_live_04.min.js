...
}).fail(function(){console.log("Error al cargar el header "+c.urlfeedHeader);});},timeUpdate:function(h,e){console.log("entrando en timeUpdate");var f=0;
...
}}console.log(f);if(f!==0){setInterval(function(){c.updateMxm();},f);}}else{if(parseFloat(p)>parseFloat(n)){console.log("MAYOR");}else{}}}}});},updateMxm:function(){var e="",f="";

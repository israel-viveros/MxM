(function(){$.fn.wdgMxmLive=function(a){var d=$.extend({idjornada:0,idmatch:0,title:""},a);var b=this;var c={urlFinal:"http://lab.israelviveros.com/deportes/wdg_mxm_live_04/"+d.idjornada+"/"+d.idmatch+"/mxm_contenido.js",callback:"datamxmvivo",urlfeedHeader:"http://lab.israelviveros.com/deportes/wdg_mxm_live_04/"+d.idjornada+"/"+d.idmatch+"/mxm_header.js",feedCallbackHeader:"mxmheader",inicio:function(){Maquetado="";
...
j++){var n="",q="";switch(o.actionsMXM[j].type.toLowerCase()){case"fueradelarea":g="";break;case"centroalarea":g="";break;case"tirodeesquina":g="";break;
case"disparoagol":g="";break;case"atajada":g="block";break;case"comentario":g="";break;case"gollocal":g="goal";break;case"saledeljuego":g="";break;case"entraaljuego":g="";
break;case"empiezasegundotiempo":g="gameend";break;case"golvisitante":g="goal";break;case"amonestacion":g="yellowcard";break;case"twitter":g="twitter";
break;}e+='<li data-id="'+f+'" style="display:none">';e+=(g==="twitter")?'<div class="time-icon twitter">':'<div class="time-icon">';e+='<div class="textcolor-title6 time">'+o.actionsMXM[j].minute+"'</div>";
if(g==="twitter"){e+='<div class="icon-time"><i class="tvsa-twitter"></i></div>';}else{e+='<div class="icon-time"><i class="tvsa-mxm-'+g+'"></i></div>';
}e+="</div>";e+=(g!=="twitter")?'<div class="chronic">'+o.actionsMXM[j].description+"</div>":"";if(g==="twitter"){var p=o.actionsMXM[j].description.replace(",","|");

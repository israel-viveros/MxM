...
j++){var n="",q="";console.log(o.actionsMXM[j].type.toLowerCase());switch(o.actionsMXM[j].type.toLowerCase()){case"amonestacion":g="mxm-yellowcard";break;
case"autogol":g="mxm-owngoal";break;case"comentario":g="mxm-comment";break;case"datoestadistico":g="mxm-statisticdata";break;case"desdeafueradelarea":g="mxm-offside";
break;case"elpartidohasidosuspendido":g="";break;case"empiezasegundotiempo":g="mxm-startsecondhalf";break;case"empiezanpenales":g="mxm-penalties";break;
case"expulsion":g="mxm-redcard";break;case"fallaelpenal":g="mxm-out";break;case"finalizaelpartido":g="mxm-gameend";break;case"fueradelugar":g="mxm-offside";
break;case"twitter":g="twitter";break;case"gol":g="mxm-goal";break;case"iniciaelsegundotiempo":g="mxm-startsecondhalf";break;case"iniciaprimertiempoextra":g="mxm-startextrafirsthalf";
break;case"iniciasegundotiempoextra":g="mxm-startextrasecondhalf";break;case"pasaporafuera":g="mxm-out";break;case"pegaenelposte":g="mxm-crossbar";break;
case"penal":g="mxm-penaltykick";break;case"segundaamonestacion":g="mxm-secondyellowcard";break;case"terminaprimertiempo":g="mxm-gameend";break;case"terminaprimertiempoextra":g="mxm-gameend";
break;case"terminasegundotiempo":g="mxm-gameend";break;case"terminasegundotiempoextra":g="mxm-gameend";break;case"falta":g="mxm-foul";break;case"tirodeesquina":g="mxm-cornerkick";
break;case"entraaljuego":g="mxm-playerin";break;default:g="";break;}e+='<li data-id="'+f+'" style="display:none">';e+=(g==="twitter")?'<div class="time-icon twitter">':'<div class="time-icon">';
e+='<div class="textcolor-title6 time">'+o.actionsMXM[j].minute+"'</div>";if(g==="twitter"){e+='<div class="icon-time"><i class="tvsa-twitter"></i></div>';
}else{e+='<div class="icon-time"><i class="tvsa-'+g+'"></i></div>';}e+="</div>";e+=(g!=="twitter")?'<div class="chronic">'+o.actionsMXM[j].description+"</div>":"";
if(g==="twitter"){var p=o.actionsMXM[j].description.replace(",","|");var m=p.split("|");var k=m[0].split("@");e+='<div class="chronic">';e+='<p class="textcolor-title2">'+k[0]+'<span class="textcolor-title4">@'+k[1]+"</span></p>";
...
}else{e+='<div class="icon-time"><i class="tvsa-mxm-'+f+'"></i></div>';}e+="</div>";e+=(f!=="twitter")?'<div class="chronic">'+m.actionsMXM[n].description+"</div>":"";

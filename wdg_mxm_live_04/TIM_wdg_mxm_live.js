		...
		var wdgLiveObj = {
				...
				.done(function(data) {					
					...
					for (var i = 0; i < data.actionsMXM.length; i++) {
						...
						switch(data.actionsMXM[i].type.toLowerCase()){
							case "fueradelarea": icono = ""; break;
							case "centroalarea": icono = ""; break;
							case "tirodeesquina": icono = ""; break;
							case "disparoagol": icono = ""; break;
							case "atajada": icono = "block"; break;
							case "comentario": icono = ""; break;
							case "gollocal": icono = "goal"; break;
							case "saledeljuego": icono = ""; break;
							case "entraaljuego": icono = ""; break;
			...
			funciones: function(){
				...
				globalThis.find('.tvsa-videocamera').live('click',function(event){ 
			    	...
			    	$(this).addClass('active textcolor-title1 tvsa-error');
			    	$('.vid_player_01.not_here').slideUp('slow').find('iframe').attr({'src': ''});
			    		parentContainer.slideDown('slow', function() {

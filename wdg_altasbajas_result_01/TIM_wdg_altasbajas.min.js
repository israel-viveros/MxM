...
k=k.replace(/[á]/,"a");k=k.replace(/[é]/,"e");k=k.replace(/[í]/,"i");k=k.replace(/[ó]/,"o");k=k.replace(/[ú]/,"u");k=k.replace(/ /,"-");return"http://televisadeportes.esmas.com/copa-mundial-fifa-brasil-2014/equipos/"+k;
},iniciar:function(o){var n=(e.tema!=="mundial")?"1":"";MaqueWdgAltas="";MaqueWdgAltas+=(e.title!=="")?'<div class="str_pleca_01"><div class="str_pleca_01_title"><h3 class="str_pleca_01_title background-color'+n+'"><a class="textcolor-title3" ><span id="title-jornada"></span><span class="str_pleca_01_arrowa selected"></span><span class="str_pleca_01_arrowb"></span></a></h3></div>':"";
...
if(e.tema!=="mundial"){c.timerCalendar=setInterval((function(){c.actualizaContenido();}),c.timeRecarga);}var l=new Date(timeDTV.timeYear+"/"+timeDTV.timeMonth+"/"+timeDTV.timeDay);
...
$.ajax({url:urFinal,jsonpCallback:c.callbackListado,dataType:"jsonp",cache:false,data:"v="+timeDTV.returnData(),success:function(s){if(s==null){s=new Array();
}c.dataCalendarH=s;for(var q=0;q<c.dataCalendarH.length;q++){var r=c.dataCalendarH[q];c.jornadaPresente=q;b+='<li data-jornada="'+r.enddate.replace(/-/gi,"/")+'"><p>'+r.name+"</p></li>";
}$("#name-jornada").html("<p>"+c.dataCalendarH[c.jornadaPresente].name+'</p><span class="tvsa-caret-down"></span>');var p=c.jornadaCalendarRoute+c.numeroTorneoAct+"/jornadas/jornada_"+c.dataCalendarH[c.jornadaPresente].weekid+".js";
$.ajax({url:p,jsonpCallback:c.callbackJornada,dataType:"jsonp",cache:false,data:"v="+timeDTV.returnData(),success:function(t){f(t);$("#feedsAct").data("primero",p);
h.fadeIn(1000);c.naat();}});}});}else{if(c.numeroTorneoAct===0&&c.numeroIdEquipo===0){h.remove();}else{if(c.Jornada2===0&&c.numeroTorneoAct===0){h.remove();
...
});}function f(V,y){if(y!=="jornada2"){c.Global.length=0;c.GlobalSort.length=0;c.contenidoJornada.length=0;c.contenidoJornada2.length=0;}var x=0;if(V==null){V=new Array();
}c.dataCalendar=V;var O=zonaGMT;var r="";var z="";var M="";var T=new Array();var K=0;var n=0;var q=0;q=V.length;for(var S=0;S<q;S++){if(S===0){h.find(".division img").attr("src",V[S].tournament.icono);
h.find(".division h2").text(V[S].tournament.name);if(V[S].tournament.icono.length>0){h.find("#ALtournamentLogo").attr("src",V[S].tournament.icono);}else{h.find("#ALtournamentLogo").hide();
}(typeof(V[S].sef)!=="undefined"&&typeof(V[S].sef.tournamentid)!=="undefined")?h.find(".controls .full-timetable").attr("href","http://stats.televisadeportes.esmas.com/futbol/torneo/"+String(V[S].tournament.name).replace(/ /g,"-").toLowerCase()+"/calendario/"+V[S].sef.tournamentid+"/"):"";
}conjunto=V[S];var H="";var l=conjunto.eventdate.split("-");var E="";switch(parseInt(l[1])){case 1:E="Ene";break;case 2:E="Feb";break;case 3:E="Mar";break;
case 4:E="Abr";break;case 5:E="May";break;case 6:E="Jun";break;case 7:E="Jul";break;case 8:E="Ago";break;case 9:E="Sep";break;case 10:E="Oct";break;case 11:E="Nov";
break;case 12:E="Dic";break;default:E="";break;}var o=l[2]+" "+E;var m=conjunto.eventtime.substring(0,5);var R=(tbaner!=undefined&&tbaner!=null&&tbaner!="")?"#"+tbaner:"";
var I=(conjunto.eventurl!=undefined&&conjunto.eventurl!=null&&conjunto.eventurl!="")?conjunto.eventurl:"";var N="";if(typeof(conjunto.sef)!=="undefined"){N=(typeof(conjunto.sef.mxmurl)!="undefined"&&conjunto.sef.mxmurl!="")?conjunto.sef.mxmurl:"";
}var A=(e.tema==="deportes")?'<img width="24" height="24" src="'+conjunto.local.team.img.logo+'"  alt="'+conjunto.local.name+'">':'<img width="24" height="24" src="'+conjunto.local.team.img.EscudoMundialF22014+'"  alt="'+conjunto.local.name+'">';
var J=(e.tema==="deportes")?'<img width="24" height="24" src="'+conjunto.visit.team.img.logo+'"  alt="'+conjunto.local.name+'">':'<img width="24" height="24" src="'+conjunto.visit.team.img.EscudoMundialF22014+'"  alt="'+conjunto.local.name+'">';
var v=(typeof(conjunto.local.team)!=="undefined")?conjunto.local.team.gol:"";var D=(typeof(conjunto.visit.team)!=="undefined")?conjunto.visit.team.gol:"";
if(typeof(conjunto.local.team)!=="undefined"&&typeof(conjunto.visit.team)!=="undefined"){if(parseInt(conjunto.local.team.pen)>0||parseInt(conjunto.visit.team.pen)>0){v='<div class="result textcolor-title2"><i class="penalT">('+conjunto.local.team.pen+')</i><i class="golT">'+v+"</i></div>";
D='<div class="result textcolor-title2" style="position: relative; left: -5px;"><i class="golT">'+D+'</i><i class="penalT">('+conjunto.visit.team.pen+")</i></div>";
}}v=(v>0||conjunto.periodo!=="Previo")?v:"";D=(D>0||conjunto.periodo!=="Previo")?D:"";var F=(typeof y!=="undefined")?"2J":"1J";H='<li class="JfromTicker'+conjunto.sef.matchid+" "+conjunto.fechastamp+" "+conjunto.eventtime+" "+F+" wdg_altasbajas_result_01_block"+((conjunto.minuto!="")?" activo":"")+'" >';
H+='<div class="date textcolor-title2">';H+='<span class="datetext inactive">'+o+"</span>";H+='<span class="time">'+m+"</span>";H+="</div>";var u=(conjunto.local.name!=="")?c.createLink(conjunto.local.name):"";
var C=(conjunto.visit.name!=="")?c.createLink(conjunto.visit.name):"";var U=(e.tema=="mundial")?'style="width:213px;margin-left:-95px;"':"";console.log(conjunto.periodo);
console.log(conjunto.sef.mxmurl);var P=(conjunto.minuto!==""&&conjunto.minuto>0)?conjunto.minuto+"'":"";var G=(conjunto.sef.mxmurl!=="")?conjunto.periodo+P:"";
H+='<figure style="cursor:pointer;" data-link="'+u+'" >'+A+"<figcaption>"+conjunto.local.abrev+"</figcaption></figure>";H+=(N!=="")?'<div class="ligaResult" style="cursor:pointer" data-link="'+N+'"><span class="result textcolor-title2">'+v+"</span>":'<div class="ligaResult" data-link=""><span class="result textcolor-title2">'+v+"</span>";
H+='<div class="content_versus"> <span class="versus textcolor-title4">-</span>';H+='<span class="versus_time textcolor-title4" '+U+">"+G+"</span></div>";
H+='<span class="result textcolor-title2">'+D+"</span></div>";H+='<figure style="cursor:pointer;" data-link="'+C+'"><figcaption>'+conjunto.visit.abrev+"</figcaption>"+J+"</figure>";
H+="</li>";if(y==="jornada2"){c.contenidoJornada2.push(H);}else{c.contenidoJornada.push(H);}}if(q<9&&e.tema!=="mundial"){var t=parseInt(9-q);for(var L=0;
L<t;L++){c.contenidoJornada.push('<li class="vacio wdg_altasbajas_result_01_block"><div class="date textcolor-title2"></div><figure></figure><div class="ligaResult"></div><figure></figure></li>');
}}c.Global=c.contenidoJornada.concat(c.contenidoJornada2);c.GlobalSort=c.Global.sort();var B="",k="";if(e.tema==="deportes"){for(var Q=0;Q<c.GlobalSort.length;
Q++){(Q<7)?B+=c.GlobalSort[Q]:k+=c.GlobalSort[Q];}}else{for(var Q=0;Q<c.contenidoJornada.length;Q++){(Q<7)?B+=c.contenidoJornada[Q]:k+=c.contenidoJornada[Q];
}}var s=B+" "+k;$(".deg").html(s);$("#nro_jornadas").html(b).children("li").bind("click",function(p){d($(this).data("jornada"));});(c.GlobalSort.length>7)?$(".controls").css("display","block"):$(".controls").css("display","none");
$("#circleGLoading").fadeOut("fast");$(".wdg_altasbajas_result_01_block figure, .wdg_altasbajas_result_01_block .ligaResult").click(function(p){p.preventDefault();
if($(this).attr("data-link")!==""){window.open($(this).attr("data-link"),"_blank");}});}};})(jQuery);if($.browser.msie&&parseInt($.browser.version,10)<=7){$(function(){var a=1000;
$(".wdg_altasbajas_result_01 div").each(function(){$(this).css("zIndex",a);a-=10;});});}
...
h.find(".division h2").text(O[I].tournament.name);(typeof(O[I].sef)!=="undefined"&&typeof(O[I].sef.tournamentid)!=="undefined")?h.find(".controls .full-timetable").attr("href","http://stats.televisadeportes.esmas.com/futbol/torneo/"+String(O[I].tournament.name).replace(/ /g,"-").toLowerCase()+"/calendario/"+O[I].sef.tournamentid+"/"):"";

...
e.on("click",function(h){console.log("drop");var i=c(this).find(".wdg_altasbajas_result_012_dropdownlist");var g=i.css("visibility");var k=c(this);if(g=="hidden"){i.css({visibility:"visible",height:"auto","max-height":"156px","overflow-y":"scroll","overflow-x":"hidden"});

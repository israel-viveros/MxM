...
h.fadeIn(1000);}});}});}else{if(c.numeroTorneoAct===0&&c.numeroIdEquipo===0){h.remove();}else{if(c.Jornada2===0&&c.numeroTorneoAct===0){h.remove();}}}},primeraJornada:function(){if(c.numeroIdEquipo!==0&&c.numeroTorneoAct!==0){urFinal=c.jornadaCalendarRoute+c.numeroTorneoAct+"/clubes/"+c.numeroIdEquipo+"/teamcalendar.js";
...
$("#feedsAct").data("primero",urFinal);h.fadeIn(1000);},fail:function(){try{c.primeraJornada();}catch(k){console.log(k);}}});h.children(".filterResultado").remove();

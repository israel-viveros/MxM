...
}$("#title-jornada").text(e.title);},jornadasCalendarDTV:function(m){clearInterval(c.timerCalendar);c.timerCalendar=setInterval((function(){c.actualizaContenido();
}),c.timeRecarga);c.fechaAct=m;var k=new Date(c.fechaAct);var l=k.getTime()/1000;if(c.numeroTorneoAct!==0&&c.numeroIdEquipo===0){$.ajax({url:c.jornadaCalendarRoute+c.numeroTorneoAct+"/jornadas/jornadalistadojsonp.js",jsonpCallback:c.callbackListado,dataType:"jsonp",cache:true,data:"v="+timeDTV.returnData(),success:function(q){if(q==null){q=new Array();
...
(n!==l)?($("."+p[q].fechastamp).children(".result").eq(1).text(n)):"";}},fail:function(){}});},naat:function(){console.log("aplicando lo de naat");(function(n,m){var o=0;
if(n(window).width()<978&&n(window).width()>624){o=568;}else{o=163;}n(".wdg_altasbajas_result_01 .deg").bind("swipeup",function(){n(this).animate({scrollTop:n(this).scrollTop()+o},500);
});n(".wdg_altasbajas_result_01 .deg").bind("swipedown",function(){n(this).animate({scrollTop:n(this).scrollTop()-o},500);});n(".wdg_altasbajas_result_01").each(function(p,q){var t=n(this),s={UP:(m.getIsTouchDevice())?"touchend":"mouseup",DOWN:(m.getIsTouchDevice())?"touchstart":"mousedown"},r=t.find(">ul");
...
});}function f(Q,y){if(y!=="jornada2"){c.Global.length=0;c.GlobalSort.length=0;c.contenidoJornada.length=0;c.contenidoJornada2.length=0;}var M=0;if(Q==null){Q=new Array();
}c.dataCalendar=Q;var C=zonaGMT;var v="";var l="";var s="";var B=new Array();var o=0;var u=0;var z=0;z=Q.length;for(var K=0;K<z;K++){if(K===0){h.find(".division img").attr("src",Q[K].tournament.icono);
h.find(".division h2").text(Q[K].tournament.name);if(Q[K].tournament.icono.length>0){h.find("#ALtournamentLogo").attr("src",Q[K].tournament.icono);}else{h.find("#ALtournamentLogo").hide();
}(typeof(Q[K].sef)!=="undefined"&&typeof(Q[K].sef.tournamentid)!=="undefined")?h.find(".controls .full-timetable").attr("href","http://stats.televisadeportes.esmas.com/futbol/torneo/"+String(Q[K].tournament.name).replace(/ /g,"-").toLowerCase()+"/calendario/"+Q[K].sef.tournamentid+"/"):"";
}conjunto=Q[K];var m="";var J=conjunto.eventdate.split("-");var H="";switch(parseInt(J[1])){case 1:H="Ene";break;case 2:H="Feb";break;case 3:H="Mar";break;
case 4:H="Abr";break;case 5:H="May";break;case 6:H="Jun";break;case 7:H="Jul";break;case 8:H="Ago";break;case 9:H="Sep";break;case 10:H="Oct";break;case 11:H="Nov";
break;case 12:H="Dic";break;default:H="";break;}var L=J[2]+" "+H;var I=conjunto.eventtime.substring(0,5);var O=(tbaner!=undefined&&tbaner!=null&&tbaner!="")?"#"+tbaner:"";
var x=(conjunto.eventurl!=undefined&&conjunto.eventurl!=null&&conjunto.eventurl!="")?conjunto.eventurl:"";if(typeof(conjunto.sef)!=="undefined"){var q=(conjunto.sef.mxmurl!=undefined&&conjunto.sef.mxmurl!=null&&conjunto.sef.mxmurl!="")?conjunto.sef.mxmurl+O:"";
...
}var N="";if(typeof(conjunto.visit.team)!=="undefined"){var N=(j==1)?'<img width="24" height="24" src="'+conjunto.visit.team.img.oficial+'" alt="'+conjunto.local.name+'">':'<img width="24" height="24" src="'+conjunto.visit.team.img.oficialno+'" alt="'+conjunto.local.name+'">';
...
}if(N=='<img width="24" height="24" src="http://i2.esmas.com/canal30/img/spacer.gif" alt="'+conjunto.local.name+'">'){N='<img width="24" height="24" src="'+conjunto.visit.team.img.logoch+'"  alt="'+conjunto.local.name+'">';
}var P=(typeof(conjunto.local.team)!=="undefined")?a(conjunto.local.team.gol,conjunto.local.team.golstatus,conjunto.fechastamp):"";var G=(typeof(conjunto.visit.team)!=="undefined")?a(conjunto.visit.team.gol,conjunto.visit.team.golstatus,conjunto.fechastamp):"";
if(typeof(conjunto.local.team)!=="undefined"&&typeof(conjunto.visit.team)!=="undefined"){if(parseInt(conjunto.local.team.pen)>0||parseInt(conjunto.visit.team.pen)>0){P='<div class="result textcolor-title2">('+conjunto.local.team.pen+") "+P+"</div>";
G='<div class="result textcolor-title2">'+G+" ("+conjunto.visit.team.pen+")</div>";}}var k=(typeof y!=="undefined")?"2J":"1J";m='<li class="'+conjunto.fechastamp+" "+conjunto.eventtime+" "+k+" wdg_altasbajas_result_01_block"+((conjunto.minuto!="")?" activo":"")+'" data-link="'+q+'">';
m+='<div class="date textcolor-title2">';m+='<span class="datetext inactive">'+L+"</span>";m+='<span class="time">'+I+"</span>";m+="</div>";m+="<figure>"+r+"<figcaption>"+conjunto.local.abrev+"</figcaption></figure>";
m+='<div class="ligaResult"><span class="result textcolor-title2">'+P+"</span>";m+='<div class="content_versus"> <span class="versus textcolor-title4">-</span>';
...
m+="<figure><figcaption>"+conjunto.visit.abrev+"</figcaption>"+N+"</figure>";m+="</li>";if(y==="jornada2"){c.contenidoJornada2.push(m);}else{c.contenidoJornada.push(m);
...
if($.browser.msie&&parseInt($.browser.version,10)<=7){$(function(){var a=1000;$(".wdg_altasbajas_result_01 div").each(function(){$(this).css("zIndex",a);
a-=10;});});}
...
$("#circleGLoading").fadeIn("fast");c.jornadasCalendarDTV(k);$("ul.deg").delay(10).fadeIn("slow");}function f(O,x){if(x!=="jornada2"){c.Global.length=0;
c.GlobalSort.length=0;c.contenidoJornada.length=0;c.contenidoJornada2.length=0;}var K=0;if(O==null){O=new Array();}c.dataCalendar=O;var C=zonaGMT;var v="";
var l="";var s="";var B=new Array();var o=0;var u=0;var z=0;z=O.length;for(var I=0;I<z;I++){if(I===0){h.find(".division img").attr("src",O[I].tournament.icono);
h.find(".division h2").text(O[I].tournament.name);h.find(".controls .full-timetable").attr("href","http://stats.televisadeportes.esmas.com/futbol/torneo/"+String(O[I].tournament.name).replace(/ /g,"-").toLowerCase()+"/calendario/"+O[I].sef.tournamentid+"/");
}conjunto=O[I];if(conjunto.tournament.id==c.numeroTorneoAct||c.numeroTorneoAct==0){var m="";var J=convierteFecha(conjunto.fechastamp,C,"dd/mmm");J=J.replace("/",".&nbsp;");
var H=convierteFecha(conjunto.fechastamp,C,"HH:MM");var M=(tbaner!=undefined&&tbaner!=null&&tbaner!="")?"#"+tbaner:"";var y=(conjunto.eventurl!=undefined&&conjunto.eventurl!=null&&conjunto.eventurl!="")?conjunto.eventurl:"";
var q=(conjunto.sef.mxmurl!=undefined&&conjunto.sef.mxmurl!=null&&conjunto.sef.mxmurl!="")?conjunto.sef.mxmurl+M:"";var r=(j==1)?'<img width="24" height="24" src="'+conjunto.local.team.img.oficial+'" alt="'+conjunto.local.name+'">':'<img width="24" height="24" src="'+conjunto.local.team.img.oficialno+'" alt="'+conjunto.local.name+'">';
var L=(j==1)?'<img width="24" height="24" src="'+conjunto.visit.team.img.oficial+'" alt="'+conjunto.local.name+'">':'<img width="24" height="24" src="'+conjunto.visit.team.img.oficialno+'" alt="'+conjunto.local.name+'">';
...
}var N=a(conjunto.local.team.gol,conjunto.local.team.golstatus,conjunto.fechastamp);var G=a(conjunto.visit.team.gol,conjunto.visit.team.golstatus,conjunto.fechastamp);
if(parseInt(conjunto.local.team.pen)>0||parseInt(conjunto.visit.team.pen)>0){N='<div class="result textcolor-title2">('+conjunto.local.team.pen+") "+N+"</div>";
...
}}if(z<9){var E=parseInt(9-z);for(var A=0;A<E;A++){c.contenidoJornada.push('<li class="vacio wdg_altasbajas_result_01_block" data-link="" style="cursor: pointer;"><div class="date textcolor-title2"></div><figure></figure><div class="ligaResult"></div><figure></figure></li>');
...
}var t=n+" "+D;$(".deg").html(t);$("#nro_jornadas").html(b).children("li").bind("click",function(p){d($(this).data("jornada"));});$(".wdg_altasbajas_result_01_block").css("cursor","pointer").bind("click",function(p){window.location.assign($(this).data("link"));

...
for(var e=0;e<f.length;e++){g=g+f[e];}return g;},typeDraft:function(n,h,l,f,i,m,j,g,e,p,o,k){switch(n){case"ALTA":d.flagTypeAltas=1;maquetado="<tr class='vote_block'>";
...
maquetado+="</div>";d.tagWdgTeamDraft.html(maquetado);setTimeout(function(){d.funcionesNaat();},100);},cl_url:function(e){b=e.search(/\?/);if(b!=-1){b=e.search(/\=/);
if(b!=-1){e=e.replace(/\=/g,"_");e=e.replace(/\&/g,"/");e=e.replace("?","/no_clean_url/");}}b=e.search(/\#/);if(b!=-1){e=e.substring(0,b);}b=e.search(/\?/);
if(b!=-1){e=e.substring(0,b);}return e;},funcionesNaat:function(){$("containerwdg_teamdraft_01 .wdg_teamdraft_01 .tblDraft .vote_block").on("touchstart",function(i){if($(window).width()>624){var h=$(this).next("tr").find("td.separador .qualifies").css("display");
...
var g=$(this).text();var i=$(this).parents("tr");var j=i.prev();var k=j.children(":first-child");var f=j.children(".textcolor-title1");var h=k.data("url");
var l="";if(typeof l=="undefined"){l=null;}if(typeof h=="undefined"){h=wdg_playerdraft_01.cl_url(h);}f.html("1");$(this).parents(".calification").hide();
...
$(".containerwdg_teamdraft_01 .wdg_teamdraft_01 .tblDraft th").css("display","block");}},getDataTeamDraft:function(){$.ajax({url:d.urlData,type:"GET",dataType:"jsonp",jsonpCallback:"teamDraft",cache:false,success:function(e){d.viewHtml(e);
},error:function(e){console.log("ERROR____");}});}};setTimeout(function(){d.getDataTeamDraft();},500);};})(jQuery);